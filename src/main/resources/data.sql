...
insert into post (id, description, user_id) values (20002, 'I want to Get AWS- Certified', 10002);
insert into post (id, description, user_id) values (20003, 'I want to learn Multi-Cloud', 10003);
